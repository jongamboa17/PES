      ...
      <>
        ...
        <div id="accordion-collapse-23" data-accordion="collapse">
          <h2 id="accordion-collapse-heading-23">
            <button type="button" class=" flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 
          ...
          <div id="accordion-collapse-body-23" class="hidden" aria-labelledby="accordion-collapse-heading-1">
            <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
              ...
              <div id="accordion-nested-collapse" data-accordion="collapse">
                ...
                <div id="accordion-nested-collapse-body-23" class="hidden" aria-labelledby="accordion-nested-collapse-heading-1">
